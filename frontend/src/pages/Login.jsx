...
const Login = () => {
  ...
  // Helper function to handle routing based on role and admin toggle
  const handlePostLoginNavigation = (user) => {
    if (user?.role === "admin" && loginAsAdmin) {
      navigate("/admin");
    ...
    <div className="min-h-screen overflow-hidden bg-[#050507] text-white relative">
      ...
      <nav className="relative z-20 max-w-[1450px] mx-auto px-6 lg:px-10 py-6 flex items-center justify-between sticky top-0">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-violet-500 to-purple-700 flex items-center justify-center shadow-[0_0_30px_rgba(139,92,246,0.45)] group-hover:scale-105 transition-transform">
          ...
          <section className="relative w-full max-w-[480px] mx-auto rounded-[28px] border border-white/[0.10] bg-white/[0.055] backdrop-blur-3xl shadow-[0_30px_100px_rgba(0,0,0,0.65)] p-6 sm:p-8 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 p-1 rounded-xl bg-black/30 border border-white/[0.04] mt-7 mb-7">
                ...
                <Link
                  to="/register"
                  className="flex items-center justify-center py-2.5 rounded-lg text-sm text-zinc-600 hover:text-zinc-300 transition"
                >
                  Register
                </Link>
              </div>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <button
                      ...
                      className="text-[10px] text-violet-400 hover:text-violet-300 transition cursor-pointer relative z-20"
                    >
                      Forgot password?
                    </button>
                  </div>
                ...
                <div className="flex items-center justify-between mt-5 mb-6">
                  <label className="flex items-center gap-2 cursor-pointer">
                    ...
                    />
                    <span className="text-[10px] text-zinc-600">Remember me</span>
                  </label>

                  {/* Option B: Admin Console Direct Login Switcher */}
                  <label className="flex items-center gap-1.5 cursor-pointer group">
                    ...
                    />
                    <span className="text-[10px] font-medium text-zinc-500 group-hover:text-violet-400 flex items-center gap-1 transition">
                      <ShieldCheck size={12} className={loginAsAdmin ? "text-violet-400" : "text-zinc-600"} />
                      Admin View
                    </span>
                  </label>
                </div>
                ...
                >
                  <span>{loginAsAdmin ? "Sign In to Admin Console" : "Sign In"}</span>
              ...
              <button
                ...
                className="w-full h-12 rounded-xl border border-white/[0.08] bg-white/[0.025] hover:bg-white/[0.05] hover:border-violet-500/30 text-sm text-zinc-400 transition flex items-center justify-center gap-3 cursor-pointer"
              >
      ...
      <div className="relative z-10 hidden lg:flex max-w-4xl mx-auto items-center justify-center gap-10 pb-8">
